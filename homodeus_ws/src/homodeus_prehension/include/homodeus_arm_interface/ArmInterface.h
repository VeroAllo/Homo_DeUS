...
Attributes:     _planningTime (type, float):
                ...
                _planningScene (type, moveit::planning_interface::PlanningSceneInterface):
                    Object to modify the scene where plan are created.
*/
class ArmInterface
{
    private:
    ...
    public:
        ...
        moveit::planning_interface::MoveGroupInterface::Plan nextJointsPlan(moveit::planning_interface::MoveGroupInterface::Plan* last_plan, double torso, double j1, double j2, double j3, double j4, double j5, double j6, double j7);
        moveit::planning_interface::MoveGroupInterface::Plan nextCartesianPlan(const moveit::planning_interface::MoveGroupInterface::Plan& last_plan, double x, double y, double z, double roll, double pitch, double yaw);
